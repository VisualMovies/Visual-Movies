...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/YoM.jpg'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002122188651') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP', '-1002122188651')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/sgrph') #Support group link ( make sure bot is admin )
